    ...
    <div className="flex flex-col p-4 gap-3">
      ...
      <section id="products" className="py-16 px-6 container mx-auto" style={{ background: "#FFFFFF" }}>
        ...
        <div className="max-w-2xl mx-auto mb-6 relative">
          ...
          <input type="text" placeholder="Search drugs, mattresses, brands..." value={search} onChange={(e) => setSearch(e.target.value)} className="w-full pl-14 pr-4 py-4 rounded-full focus:outline-none focus:ring-2 text-sm shadow-sm" style={{ border: `1px solid ${COLORS.line}` }} />
        </div>
      ...
      <a href={waLink(PHARMACIST_WA, `Hello Pharmacist, I need help with:`)} target="_blank"
        className="fixed bottom-6 right-6 z-50 flex items-center gap-2 px-6 py-4 rounded-full font-bold shadow-2xl hover:scale-105 transition"
        style={{ background: COLORS.gold, color: COLORS.ink }}>
        <MessageCircle size={20} /> Speak to Pharmacist
      </a>
